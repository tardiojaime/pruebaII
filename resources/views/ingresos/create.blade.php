<div class="w-full p-5 sm:p-10 md:p-15">
    ...
    <form action="/Ingresos" method="POST" class="space-y-2 mt-3">
        @csrf
        <div class="grid grid-cols-2 gap-4 mb-5">
            <div>
                <label for="prove" class="text-sm font-medium text-indigo-500">
                    Proveedor
                </label>
        ...
        <div class="overflow-x-auto hidden" id="contenedor_table">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                <div class="shadow overflow-hgridy-2 text-left text-xs font-medium text-gray-500 uppercase">
        ...
        <div class="flex justify-between">
            <input type="submit" value="Agregar" id="enviar-ingreso"
            ...
            <a href="#"
                class="py-1 px-8 border-transparent text-sm font-medium rounded-bl-lg rounded-tr-lg text-white bg-red-600 hover:bg-red-800 ">Cancelar</a>
        </div>
    </form>
</div>
