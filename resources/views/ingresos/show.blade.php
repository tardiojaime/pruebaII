<div class="flex flex-col mt-5">
    ...
    <div class="grid grid-cols-2 gap-4 border rounded-md shadow-xl px-3 py-3">
        <div>
            ...
            <input type="text" value="{{$ingreso->precio}}" disabled
        ...
        <div>
            ...
            <input type="text" value="{{$ingreso->fecha}}" disabled
                class="w-full py-1  px-2 border border-gray-200 rounded-bl-lg rounded-tr-lg">
        </div>
        <div>
            <label class="text-sm font-medium text-indigo-500">Proveedor</label>
            <input type="text" value="{{$ingreso->usuario}}" disabled
                class="w-full py-1  px-2 border border-gray-200 rounded-bl-lg rounded-tr-lg">
        </div>
        <div>
