<div class="w-full p-5 sm:p-10 md:p-15">
    ...
    <form action="/Articulos" method="POST" enctype="multipart/form-data" class="space-y-2 mt-3">
        @csrf
        ...
        <div class="flex justify-between">
            ...
            <a href="#" value="Cancelar" class="py-1 px-8 border-transparent text-sm font-medium rounded-bl-lg rounded-tr-lg text-white bg-red-600 hover:bg-red-800 ">Volver</a>
        </div>
    </form>
</div>