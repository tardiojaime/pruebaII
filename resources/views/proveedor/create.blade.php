<div class="w-full p-5 sm:p-10 md:p-15">
    ...
    <form action="/Proveedores" method="POST"  class="space-y-2 mt-3">
        @csrf
        ...
        <div class="flex justify-between">
            <input type="submit" value="Agregar" id="enviar_provee" class="py-1 px-8 border-transparent text-sm font-medium rounded-bl-lg rounded-tr-lg text-white bg-indigo-600 hover:bg-indigo-800">
