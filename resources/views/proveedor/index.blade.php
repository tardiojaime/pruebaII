<div class="flex flex-col mt-5">
    <div class="flex justify-between px-8">
        <h2 class="text-sm font-medium text-indigo-800 hover:text-indigo-500">Lista de Proveedores</h2>
        <a href="#" id="create-p"
                        ...
                        <tr>
                            ...
                            <td class="pr-2 py-2">
                                <div class="w-full flex justify-center justify-between">
                                    <a href="{{URL::action('ProveedorController@show', $user->id)}}"
                                        class="btn-enlaces view-proveedor">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{URL::action('ProveedorController@edit', $user->id)}}" 
                                      class="btn-enlaces edit-provee">
                                        <i class="fas fa-pen-alt"></i>
                                    </a>
                                    <a href="#" class="btn-enlaces page delete-article" ids="{{$user->id}}" nombre="{{$user->nombre}}">
